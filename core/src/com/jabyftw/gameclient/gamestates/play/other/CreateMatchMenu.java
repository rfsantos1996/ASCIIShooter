 ...
 */
public class CreateMatchMenu extends TabledGameState implements PseudoGameState {

    public CreateMatchMenu() {
        super(true);
    }
    ...
    public void create() {
        ...
        gameStateTitleString = Resources.getLang(LangEnum.CREATE_MATCH_BUTTON);

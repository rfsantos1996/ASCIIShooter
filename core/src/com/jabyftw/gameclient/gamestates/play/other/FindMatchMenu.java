 ...
 */
public class FindMatchMenu extends TabledGameState implements PseudoGameState {

    public FindMatchMenu() {
        super(true);
    }
    ...
    public void create() {
        ...
        gameStateTitleString = Resources.getLang(LangEnum.FIND_MATCH_BUTTON);
